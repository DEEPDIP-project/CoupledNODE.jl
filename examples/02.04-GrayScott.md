...
burnout_CNODE = create_f_CNODE((F_u, G_v), (grid_GS_u, grid_GS_v), trange_burn, Tsit5();  adaptive = false, dt = dt_burn, saveat = saveat_burn);
...
dt, saveat = (0.1, 0.1);
full_CNODE = create_f_CNODE((F_u, G_v), (grid_GS_u, grid_GS_v), trange, Tsit5();  adaptive = false, dt = dt, saveat = saveat);
...
```julia
using Images
les_CNODE = create_f_CNODE((F_u, G_v), (grid_GS_u, coarse_grid), trange, Tsit5(), pre_force = upscaler_v,
...
import DifferentialEquations: Vern7
```

We define the model to train

```julia
training_CNODE = create_f_CNODE((F_u, G_v), (grid_GS_u, coarse_grid), t_train_range, Vern7(), (NN_u, NN_v), adaptive = false, dt = dt_train, saveat = saveat_train, pre_force = upscaler_v, post_force = downscaler_v, is_closed = true);
...
trained_CNODE = create_f_CNODE((F_u, G_v), (grid_GS_u, coarse_grid), trange, Tsit5(), (NN_u, NN_v), adaptive = false, dt = dt_train, saveat = saveat_train, pre_force = upscaler_v, post_force = downscaler_v, is_closed = true);
