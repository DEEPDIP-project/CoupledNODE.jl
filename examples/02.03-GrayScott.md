...
```julia
dns_CNODE_burnout = create_f_CNODE((F_u, G_v), (grid_dns_u, grid_dns_v), trange_burn, Tsit5(); adaptive = false, dt = dt_burn, saveat = saveat_burn);
...
```julia
uv0 = burnout_dns[:, :, end];
dns_CNODE = create_f_CNODE((F_u, G_v), (grid_dns_u, grid_dns_v), trange, Tsit5(); adaptive = false, dt = dt, saveat = saveat);
...
```julia
les_CNODE_burnout = create_f_CNODE((F_u, G_v), (grid_les_u, grid_les_v), trange_burn, Tsit5(); adaptive = false, dt = dt_burn, saveat = saveat_burn);
...
```julia
uv0 = burnout_les[:, :, end];
les_CNODE = create_f_CNODE((F_u, G_v), (grid_les_u, grid_les_v), trange, Tsit5(); adaptive = false, dt = dt, saveat = saveat);
